...
export default defineNuxtPlugin(() => {
  onGlobalSetup(() => {
    ...
    provide(Keys.GetTasksUseCase, getTasksUseCase)
    ...
    provide(Keys.CreateTaskUseCase, createTaskUseCase)

    provide(Keys.TaskController, new TaskController(createTaskUseCase, getTasksUseCase))
  })
})
